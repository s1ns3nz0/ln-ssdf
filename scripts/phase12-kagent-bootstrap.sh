...
# The local Ollama route needs no provider credential.
set -euo pipefail
...
helm upgrade --install kagent oci://ghcr.io/kagent-dev/kagent/helm/kagent \
  ...
  --set-string providers.openAI.model=gpt-oss:20b \
...
# a public placeholder only; local Ollama does not require authentication.
...
echo "kagent 0.6.3 Phase 12 agent is Ready with local Ollama gpt-oss:20b."
